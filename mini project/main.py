...
def paused():
    ...
    while paused:
        ...
        largetext=pygame.font.Font("RubikGlitch-Regular.ttf",80)
...
#for continue
        ...
        if mouse[0]>70 and mouse[0]<310 and mouse[1]>230 and mouse[1]<290:
            pygame.draw.rect(screen,(255,255,255),(70,230,240,50))
            if click==(1,0,0):
                paused=False
                
        smalltext=pygame.font.Font("RubikGlitch-Regular.ttf",40)
...
#for restart
        ...
        if mouse[0]>70 and mouse[0]<310 and mouse[1]>330 and mouse[1]<380:
            pygame.draw.rect(screen,(255,255,255),(70,330,240,50))
            if click==(1,0,0):
                game_loop()
        smalltext=pygame.font.Font("RubikGlitch-Regular.ttf",40)
...
#for main menu
        ...
        if mouse[0]>70 and mouse[0]<310 and mouse[1]>430 and mouse[1]<480:
            pygame.draw.rect(screen,(255,255,255),(70,430,240,50))
            if click==(1,0,0):
                intro_loop()
...
def instruction():
    ...
    while instruction:
        ...
        screen.blit(instruction_background,(0,0))
        largetext=pygame.font.Font("RubikGlitch-Regular.ttf",80)
        mediumtext=pygame.font.Font("RubikGlitch-Regular.ttf",40)
        smalltext=pygame.font.Font("RubikGlitch-Regular.ttf",30)
        textsurface,textrect=text_objects("INSTRUCTION",largetext)
        textrect.center=((400,100))
        screen.blit(textsurface,textrect)
        textsurface1,textrect1=text_objects("ARROW LEFT: LEFT DISPLACEMENT",smalltext)
        textrect1.center=((290,200))
        screen.blit(textsurface1,textrect1)
        textsurface2,textrect2=text_objects("ARROW RIGHT: RIGHT DISPLACEMENT",smalltext)
        textrect2.center=((300,300))
        screen.blit(textsurface2,textrect2)
        textsurface3,textrect3=text_objects("K_a: ACCELERATOR",smalltext)
        textrect3.center=((170,400))
        screen.blit(textsurface3,textrect3)
        textsurface4,textrect4=text_objects("K_b: BREAK",smalltext)
        textrect4.center=((150,480))
        screen.blit(textsurface4,textrect4)
        textsurface5,textrect5=text_objects("P: PAUSE",smalltext)
        textrect5.center=((150,560))
        screen.blit(textsurface5,textrect5)
        pygame.draw.rect(screen,(255,255,255),(640,400,150,50))            
        mouse=pygame.mouse.get_pos()
...
def intro_loop():
    ...
    while intro:
        ...
        font=pygame.font.Font("RubikGlitch-Regular.ttf",80)
        title=font.render("CAR RACE GAME",1,(0,255,0))
        ...
        if mouse[0]>70 and mouse[0]<300 and mouse[1]>150 and mouse[1]<250:
            pygame.draw.rect(screen,(255,255,255),(80,150,220,90))
            if click==(1,0,0):
                countdown()
        if mouse[0]>300 and mouse[0]<640 and mouse[1]>250 and mouse[1]<340:
            pygame.draw.rect(screen,(255,255,255),(300,250,300,90))
            if click==(1,0,0):
                instruction()
        if mouse[0]>550 and mouse[0]<780 and mouse[1]>150 and mouse[1]<250:
            pygame.draw.rect(screen,(255,255,255),(560,150,220,90))
            if click==(1,0,0):
                pygame.quit()
                quit()
...
myfont=pygame.font.Font("RubikGlitch-Regular.ttf",70)
...
def countdown_background():
    for event in pygame.event.get():
            if event.type==pygame.QUIT:
                ...
                quit()
                sys.exit()
    font=pygame.font.Font("RubikGlitch-Regular.ttf",35)
    x=(width*0.45)
    y=(height*0.8)
...
def countdown():
    ...
    while countdown:
        ...
        screen.fill((119,118,110))
        countdown_background()
        largetext=pygame.font.Font("RubikGlitch-Regular.ttf",115)
